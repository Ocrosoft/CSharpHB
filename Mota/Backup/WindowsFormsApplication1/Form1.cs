...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private int Math.Abs(shengming) = 498;//498
        ...
        Bitmap xueliang = new Bitmap(@"Image\Math.Abs(shengming).png");
            ...
            switch (map[cengshu].mp[j * 13 + i])
            {
                ...
                case 3:
                    if (gongji <= _monsinfo[3].fangyu)
                        return false;
                    if (Math.Abs(Math.Abs(shengming)) <= damage(3))
                        return false;
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(3);
                ...
                case 4:
                    ...
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(4);
                        jingbi += _monsinfo[4].jingqian;
                        map[cengshu].mp[j * 13 + i] = 1;
                    }
                    break;
                case 5:
                    Math.Abs(Math.Abs(shengming)) += 50;
                    map[cengshu].mp[j * 13 + i] = 1;
                    break;
                case 6:
                    Math.Abs(Math.Abs(shengming)) += 200;
                    map[cengshu].mp[j * 13 + i] = 1;
                    break;
                case 7:
                    gongji++;
                ...
                case 12:
                    ...
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(12);
                ...
                case 13:
                    if (gongji <= _monsinfo[13].fangyu)
                        return false;
                    if (Math.Abs(Math.Abs(shengming)) <= damage(13))
                        return false;
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(13);
                ...
                case 14:
                    if (gongji <= _monsinfo[14].fangyu)
                        return false;
                    if (Math.Abs(Math.Abs(shengming)) <= damage(14))
                        return false;
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(14);
                ...
                case 15:
                    if (gongji <= _monsinfo[15].fangyu)
                        return false;
                    if (Math.Abs(Math.Abs(shengming)) <= damage(15))
                        return false;
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(15);
                ...
                case 23:
                    ...
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(23);
                ...
                case 24:
                    if (gongji <= _monsinfo[24].fangyu)
                        return false;
                    if (Math.Abs(Math.Abs(shengming)) <= damage(24))
                        return false;
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(24);
                ...
                case 32:
                    if (gongji <= _monsinfo[32].fangyu)
                        return false;
                    if (Math.Abs(Math.Abs(shengming)) <= damage(32))
                        return false;
                    else
                    {
                        battle.Enabled = true;
                        zhandou = true;
                        Math.Abs(Math.Abs(shengming)) -= damage(32);
        ...
        {
            gongji = -gongjil;
            Math.Abs(shengming) = -Math.Abs(shengming);
            fangyu = -fangyu;
            xueliang = -xueliang;
            jingbi = -jingbi;
            cengshu = -cengshu;
