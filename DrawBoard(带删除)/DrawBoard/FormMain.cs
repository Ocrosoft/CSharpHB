    ...
    public partial class FormMain : Form
    {
        ...
        private void FormMain_MouseDown(object sender, MouseEventArgs e)
        {
            if (this.Cursor != Cursors.SizeNS && this.Cursor != Cursors.SizeNWSE && this.Cursor != Cursors.SizeWE)
            {
                ...
                else if (_operatopnType == OperationType.Delete)
                {
                    for (int i = this._listShape.Count - 1; i >= 0; i--)
                    {
                        if (this._listShape[i].Select(this.PointFromDisplayToReal(new Point(e.X, e.Y)), (double)((this._listShape[i]._PenWidth / 2) + 1)))
                        {
                            this._listShape.RemoveAt(i);
                            this._bufferGraphics.Clear(Color.White);
                            System.Drawing.Rectangle destRect = new System.Drawing.Rectangle(0, 0, this.panelDraw.Width, this.panelDraw.Height);
                            System.Drawing.Rectangle srcRect = new System.Drawing.Rectangle(0, 0, this._screenBmp.Width, this._screenBmp.Height);
                            this._bufferGraphics.DrawImage(this._screenBmp, destRect, srcRect, GraphicsUnit.Pixel);
                            ...
                            {
                                toolStripUndo.Enabled = false; buttonUndo.Enabled = false;
                            }
                            break;
                        }
                    }
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            this._screenBmp = new Bitmap(this._initialSize.Width, this._initialSize.Height);
            this._screenGraphics = Graphics.FromImage(this._screenBmp);
            this._screenGraphics.Clear(Color.White);
        ...
        public void MenuItemUndo_Click(object sender, EventArgs e)
        {
            ...
            if (_listShape.Count != 0)
            {
                this._listShape.RemoveAt(this._listShape.Count - 1);
                this._bufferGraphics.Clear(Color.White);
                System.Drawing.Rectangle destRect = new System.Drawing.Rectangle(0, 0, this.panelDraw.Width, this.panelDraw.Height);
                System.Drawing.Rectangle srcRect = new System.Drawing.Rectangle(0, 0, this._screenBmp.Width, this._screenBmp.Height);
                this._bufferGraphics.DrawImage(this._screenBmp, destRect, srcRect, GraphicsUnit.Pixel);
        ...
        private void MenuItemNew_Click(object sender, EventArgs e)
        {
            ...
            _listShape.Clear();
            _bufferBmp.Dispose();
            _initialSize.Width = 677;
            _initialSize.Height = 425;
            _bufferBmp = new Bitmap(_initialSize.Width, _initialSize.Height);
            this._bufferGraphics = Graphics.FromImage(this._bufferBmp);
            this.panelDraw.Width = this._initialSize.Width;
            this.panelDraw.Height = this._initialSize.Height;
            _bufferGraphics.Clear(Color.White);
            _zoomRatio = 1;
        ...
        private void MenuItemPrtScn_Click(object sender, EventArgs e)
        {
            ...
            Thread.Sleep(200);
            this._initialSize.Width = Screen.PrimaryScreen.Bounds.Width;
            this._initialSize.Height = Screen.PrimaryScreen.Bounds.Height;
            this._zoomRatio = 1.0;
            this._bufferBmp.Dispose();
            this._bufferBmp = new Bitmap(this._initialSize.Width, this._initialSize.Height);
            this._bufferGraphics = Graphics.FromImage(this._bufferBmp);
            this._bufferGraphics.Clear(Color.White);
            this._bufferGraphics.SmoothingMode = SmoothingMode.AntiAlias;
            this._bufferGraphics.CopyFromScreen(0, 0, 0, 0, new Size(this._initialSize.Width, this._initialSize.Height));
            this._screenBmp.Dispose();
            this._screenBmp = new Bitmap(this._initialSize.Width, this._initialSize.Height);
            this._screenGraphics = Graphics.FromImage(this._screenBmp);
            this._screenGraphics.Clear(Color.White);
            this._screenGraphics.SmoothingMode = SmoothingMode.AntiAlias;
            this._screenGraphics.DrawImage(this._bufferBmp, 0, 0);
            this.panelDraw.Width = (int)(this._initialSize.Width * this._zoomRatio);
            this.panelDraw.Height = (int)(this._initialSize.Height * this._zoomRatio);
            this.panelDraw.CreateGraphics().DrawImage(this._bufferBmp, 0, 0);
        ...
        {
            this._operatopnType = OperationType.Delete;
            this.toolStripStatusLabelInfo.Text = "当前操作：删除图元";
            //this.Cursor = new Cursor("Pick.cur");
            MenuItemLine.CheckState = CheckState.Unchecked;
            MenuItemRectangle.CheckState = CheckState.Unchecked;
            MenuItemCircle.CheckState = CheckState.Unchecked;
            MenuItemStop.CheckState = CheckState.Unchecked;
            MenuItemSketch.CheckState = CheckState.Unchecked;
            toolStripDelete.CheckState = CheckState.Checked;
            toolStripLine.CheckState = CheckState.Unchecked;
            toolStripRectangle.CheckState = CheckState.Unchecked;
            toolStripCircle.CheckState = CheckState.Unchecked;
            toolStripStop.CheckState = CheckState.Unchecked;
