...
namespace RhythmEdit
{
    public partial class FormEditor : Form
    {
        ...
        {
            MessageBox.Show("©ACMSaga Inc. All rights reserved.", "关于");
        }
        //取消修改
        ...
        //修改模式
        private void radioPatternFull_Click(object sender, EventArgs e)
        {
            //改变选中
            if (checkBoxA.Checked == true)
            {
                numericKeyCount.Value -= 1;
                checkBoxA.Checked = false;
            }
            ...
            buttonSem.Enabled = true;
            //模式改为全键
            _pattern = 1;
        }
        private void radioPatternNormal_Click(object sender, EventArgs e)
        {
            //禁用A和分号按钮
            buttonA.Enabled = false;
            buttonSem.Enabled = false;
            //模式改为普通
            _pattern = 0;
        }
        //修改（按钮）
        ...
        private void MenuItemSave_Click(object sender, EventArgs e)
        {
            ...
            string savePath = System.IO.Path.GetTempPath() + "RTMP\\";
            if (System.IO.Directory.Exists(System.IO.Path.GetTempPath() + "RTMP"))
                System.IO.Directory.Delete(System.IO.Path.GetTempPath() + "RTMP",true);
            System.IO.Directory.CreateDirectory(savePath);
            System.IO.File.Copy(_openmp3, savePath + "song.mp3");
            ...
            binaryWriter.Write(_pattern);//模式
        ...
        private void MenuItemOpen_Click(object sender, EventArgs e)
        {
            ...
            UnZipFile(_openSong);
            string songPath = System.IO.Path.GetTempPath() + "ROTMP\\";
            ...
            _pattern = binaryReader.ReadInt32();//模式
        ...
        private void MenuItemNew_Click(object sender, EventArgs e)
        {
            ...
            listBoxSave.Items.Clear();
            listBoxShow.Items.Clear();
            radioPatternNormal.Checked = true;
            buttonCancelReWrite.PerformClick();
            //清理勾选,计数清零
            checkBoxA.Checked = false;
            checkBoxS.Checked = false;
